...
# Easy
# Countries with missing capitals
country_without_capitals = []
for country in countries_data:
    if country["capital"] == "":
        country_without_capitals.append(country["name"])

print(country_without_capitals)

# multilingual countries
multilingual_countries_list = []
for country in countries_data:
    if len(country["languages"]) > 2:
        multilingual_countries = (country["name"], len(country["languages"]))
        multilingual_countries_list.append(multilingual_countries)

print(multilingual_countries_list)

# currency search
countries_using_euro = []
for country in countries_data:
    if "Euro" == country["currency"]:
        countries_using_euro.append(country["name"])

print(countries_using_euro)

# Zero or Small Population
zero_or_small_countries_data = []
for country in countries_data:
    if country["population"] < 1000:
        small_countries = (country["name"], country["population"])
        zero_or_small_countries_data.append(small_countries)

print(zero_or_small_countries_data)

# specific Language filter
spanish_official_countries = []
for country in countries_data:
    if "Spanish" in country["languages"]:
        spanish_official_countries.append(country["name"])

print(spanish_official_countries)
...
for country in countries_data:
        ...
        country_populations_list.append(country_populations)
...
sum_of_all_coutries_population = 0
for country in countries_data:
    sum_of_all_coutries_population += country["population"]
